...
pet1 = Pet.create(name: "Ari", approximate_age: 2, sex: "Male", image: "image", shelter_id: shelter1.id)
pet2 = Pet.create(name: "Axel", approximate_age: 2, sex: "Male", image: "image", shelter_id: shelter2.id)
